...
wandb.init(project = "Fine tune Cross Pseudo Label 2 Deeplabv3 + Update dice loss")
...
model , optimizer_l, optimizer_r, s_epoch = \
    load_checkpoint("weights/checkpoint_epoch_33.pth", network, optimizer_l, optimizer_r, s_epoch)
model.train()
print('begin train')
