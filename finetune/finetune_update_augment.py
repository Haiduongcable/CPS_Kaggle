...
wandb.init(project = "Cross Pseudo Label change learning rate + Augment + GPU local")
...
model , optimizer_l, optimizer_r, s_epoch = \
    load_checkpoint("/home/asilla/duongnh/project/Analys_COCO/tmp_folder/CPS_Kaggle/weights/checkpoint_epoch_5.pth", network, optimizer_l, optimizer_r, s_epoch)
model.train()
# _, pred_sup_l = model(imgs, step=1)
# print(pred_sup_l[0,0,:10,:10])
