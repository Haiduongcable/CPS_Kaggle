...
if config["use_wandb"]:
    ...
    wandb.init(project = "Medical Image Deeplabv3+ Segformer")
...
# define and init the model
num_classes = 1
model = Network(num_classes, criterion=None,
...
best_dice = -1
path_save = "medical_weight/best_deeplabresnet101_segformer.pth"
